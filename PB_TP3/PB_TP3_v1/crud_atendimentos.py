...
#RESOLVER PROBLEMA DE ADICIONAR PRODUTOS (adicionando somente 1 produto a lista de produtos_comprados)
    ...
    for index, produto in enumerate(lista_produtos):
        if (produto[0] == produto_id):
            ...
            if (int(produto[2]) >= quantidade):
                ...
                return [produto[0], produto[1], quantidade, produto[3], preco_total]
            else:
